...
//    public final static int ACTION_COUNT = 3;
    ...
    @Override
    public void startFaceKyc(@NonNull Context context, @NonNull LifecycleOwner lifecycleOwner, @NonNull PreviewView previewView, View viewFace, @NonNull OnFaceKycDetectListener onFaceKycDetectListener) {
        ...
        cameraProviderFuture.addListener(
                () -> {
                    try {
                        bindAllCameraUseCases(context, lifecycleOwner, previewView, viewFace, cameraProviderFuture.get(), cameraSelector, onFaceKycDetectListener);
    ...
    private void bindAllCameraUseCases(Context context, LifecycleOwner lifecycleOwner, PreviewView previewView, View viewFace, ProcessCameraProvider cameraProvider, CameraSelector cameraSelector, OnFaceKycDetectListener onFaceKycDetectListener) {
        if (cameraProvider != null) {
            // As required by CameraX API, unbinds all use cases before trying to re-bind any of them.
            cameraProvider.unbindAll();
            bindPreviewUseCase(lifecycleOwner, previewView, cameraProvider, cameraSelector);
            bindAnalysisUseCase(context, previewView, viewFace, lifecycleOwner, cameraProvider, cameraSelector, onFaceKycDetectListener);
        }
    }
...
//        actions.add(SMILE);
    ...
    private void bindAnalysisUseCase(Context context, PreviewView previewView, View viewFace, LifecycleOwner lifecycleOwner, ProcessCameraProvider cameraProvider, CameraSelector cameraSelector, OnFaceKycDetectListener onFaceKycDetectListener) {
        if (cameraProvider == null) {
            return;
        }
